...
class SqlAlchemyIncidentRepository:
    ...
    This adapter translates between Incident domain objects
    and IncidentModel persistence objects.

    It flushes pending database work but never commits.
    """
        ...
        *,
        ...
        if search:
            ...
            statement = statement.where(
                or_(
                    IncidentModel.title.ilike(
                        pattern
                    ),
                    IncidentModel.summary.ilike(
                        pattern
                    ),
                    IncidentModel.assignee.ilike(
                        pattern
                    ),
                )
            )
