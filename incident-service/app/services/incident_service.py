...
class IncidentService:
    ...
    def __init__(
        ...
        self._service_catalog_gateway = service_catalog_gateway
    ...
    def update(
        ...
        if (
            ...
            and payload.service_id != existing.service_id
        ):
            self._ensure_service_exists(
                payload.service_id
            )
        ...
        resolved_at = self._resolve_timestamp(
            existing=existing,
            payload=payload,
        ...
        acknowledged_at = (
            ...
            if "acknowledged_at" in payload.model_fields_set
        ...
        updated = replace(
            ...
            customer_impacting=(
                ...
                if payload.customer_impacting is not None
                else existing.customer_impacting
            ),
    ...
    def _ensure_service_exists(
        ...
        if not self._service_catalog_gateway.service_exists(
            service_id
        ):
    ...
    def _resolve_timestamp(
        *,
        ...
        if updated_status is not IncidentStatus.RESOLVED:
            return None
