...
flowchart TD
    Browser["Browser"]
    Frontend["React + NGINX<br/>127.0.0.1:5173"]
    Backend["Core Backend<br/>127.0.0.1:8000"]
    Incident["Incident Service<br/>private port 8000"]
    Database["PostgreSQL<br/>127.0.0.1:5433"]
...
1. Trailing-whitespace validation
2. Backend Ruff and pytest
3. Incident Service Ruff and pytest
4. Frontend Oxlint, Vitest, and production build
5. Docker Compose build and smoke verification
